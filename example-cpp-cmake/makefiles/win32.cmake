...
set(PROTOC_EXECUTABLE ${HL2SDK_ROOT}/devtools/bin/protoc.exe)

set(LINK_LIBRARIES
        ${HL2SDK_LIB}/public/win64/2015/libprotobuf.lib
        ${HL2SDK_LIB}/public/win64/mathlib.lib
        ${HL2SDK_LIB}/public/win64/tier0.lib
        ${HL2SDK_LIB}/public/win64/tier1.lib
        ${HL2SDK_LIB}/public/win64/interfaces.lib
)
